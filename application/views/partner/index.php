                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="fname" name="fname" placeholder="Legal First Name:">
								        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="mname">Legal Middle Name:</label>
                                            <input type="text" class="form-control" id="mname" name="mname" placeholder="Legal Middle Name:">
								        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="lname">*Legal Last Name:</label>
                                            <input type="text" class="form-control" id="lname" name="lname" placeholder="Legal Last Name:">
								        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="altMobile" name="altMobile" placeholder="Alternate Number:">
								        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="sNumber" name="sNumber" placeholder="Street Number:">
								        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control inactive" id="otherMStatus" name="otherMStatus" placeholder="Other Military Status:">
								        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="experience" name="experience" placeholder="How many years of retail experience do you have?">
								        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="experienceManagement" name="experienceManagement" placeholder="How many years of management experience do you have?">
								        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="firstNameSpouse" name="firstNameSpouse" placeholder="Spouse First Name:">
								        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="middleNameSpouse" name="middleNameSpouse" placeholder="Spouse Middle Name:" >
								        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="lastNameSpouse" name="lastNameSpouse" placeholder="Spouse Last Name:">
								        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="spouseDateBirth" name="spouseDateBirth" placeholder="Spouse's Date of Birth (mm/dd/yyyy):">
								        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="invest">*What is the maximum you are able to invest in this business opportunity? (i.e. 401k)</label><br>
                                            <input type="text" class="form-control" id="invest" name="invest" placeholder="What is the maximum you are able to invest in this business opportunity? (i.e. 401k)">
								        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="liquid" name="liquid" placeholder="How much of the investment is liquid? (cash or checking or saving account)">
								        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="signature" name="signature" placeholder="Applicant's Signature:">
								        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <p id="msgEmpty" style="color: red; font-weight: bold; display: none;">One or more required fields are empty, please fill in all the required fields.</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12" style="text-align: center;">
                                        <button type="submit" class="btn btn-default" id="applicatePartner">Submit</button> 
